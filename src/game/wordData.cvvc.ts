...
export const QUEST_CVVC_LONG_A: Quest = {
  ...
  words: [
    ...
    { word: "tail", imageKey: "tail", letters: ["t", "a", "i", "l"], distractors: [], mode: "decode" },
    { word: "sail", imageKey: "sail", letters: ["s", "a", "i", "l"], distractors: [], mode: "decode" },
    { word: "pail", imageKey: "pail", letters: ["p", "a", "i", "l"], distractors: ["t"], mode: "decode" },
...
export const QUEST_CVVC_LONG_E: Quest = {
  ...
  words: [
    ...
    { word: "feed", imageKey: "feed", letters: ["f", "e", "e", "d"], distractors: [], mode: "decode" },
    { word: "feel", imageKey: "feel", letters: ["f", "e", "e", "l"], distractors: [], mode: "decode" },
    { word: "deep", imageKey: "deep", letters: ["d", "e", "e", "p"], distractors: [], mode: "decode" },
    { word: "keep", imageKey: "keep", letters: ["k", "e", "e", "p"], distractors: ["d"], mode: "decode" },
    { word: "week", imageKey: "week", letters: ["w", "e", "e", "k"], distractors: ["n"], mode: "decode" },
    { word: "peel", imageKey: "peel", letters: ["p", "e", "e", "l"], distractors: ["d", "a"], mode: "decode" },
    { word: "heel", imageKey: "heel", letters: ["h", "e", "e", "l"], distractors: ["s", "a"], mode: "decode" },
    { word: "weed", imageKey: "weed", letters: ["w", "e", "e", "d"], distractors: [], mode: "decode" },
    ...
    { word: "jeep", imageKey: "jeep", letters: ["j", "e", "e", "p"], distractors: ["n"], mode: "decode" },
    { word: "beef", imageKey: "beef", letters: ["b", "e", "e", "f"], distractors: ["n", "i"], mode: "decode" },
...
export const QUEST_CVVC_LONG_O: Quest = {
  ...
  words: [
    ...
    { word: "road", imageKey: "road", letters: ["r", "o", "a", "d"], distractors: [], mode: "decode" },
    { word: "toad", imageKey: "toad", letters: ["t", "o", "a", "d"], distractors: ["n"], mode: "decode" },
    { word: "load", imageKey: "load", letters: ["l", "o", "a", "d"], distractors: ["s"], mode: "decode" },
    { word: "foam", imageKey: "foam", letters: ["f", "o", "a", "m"], distractors: ["d", "e"], mode: "decode" },
    { word: "coal", imageKey: "coal", letters: ["c", "o", "a", "l"], distractors: [], mode: "decode" },
    ...
    { word: "foal", imageKey: "foal", letters: ["f", "o", "a", "l"], distractors: ["t", "i"], mode: "decode" },
    { word: "moat", imageKey: "moat", letters: ["m", "o", "a", "t"], distractors: ["l", "e"], mode: "decode" },
  ],
};
...
export const QUEST_CVVC_LONG_U: Quest = {
  ...
  words: [
    ...
    { word: "room", imageKey: "room", letters: ["r", "o", "o", "m"], distractors: [], mode: "decode" },
    ...
    { word: "loop", imageKey: "loop", letters: ["l", "o", "o", "p"], distractors: ["t", "a"], mode: "decode" },
    { word: "roof", imageKey: "roof", letters: ["r", "o", "o", "f"], distractors: [], mode: "decode" },
    { word: "cool", imageKey: "cool", letters: ["c", "o", "o", "l"], distractors: [], mode: "decode" },
    { word: "fool", imageKey: "fool", letters: ["f", "o", "o", "l"], distractors: [], mode: "decode" },
    { word: "tool", imageKey: "tool", letters: ["t", "o", "o", "l"], distractors: [], mode: "decode" },
    { word: "zoom", imageKey: "zoom", letters: ["z", "o", "o", "m"], distractors: ["l"], mode: "decode" },
    { word: "boom", imageKey: "boom", letters: ["b", "o", "o", "m"], distractors: ["n"], mode: "decode" },
    { word: "loom", imageKey: "loom", letters: ["l", "o", "o", "m"], distractors: ["s", "a"], mode: "decode" },
    { word: "hoot", imageKey: "hoot", letters: ["h", "o", "o", "t"], distractors: ["p", "i"], mode: "decode" },
  ],
};
...
export const QUEST_CVVC_MIXED_EA: Quest = {
  ...
  words: [
    ...
    { word: "bean", imageKey: "bean", letters: ["b", "e", "a", "n"], distractors: [], mode: "decode" },
    { word: "meal", imageKey: "meal", letters: ["m", "e", "a", "l"], distractors: [], mode: "decode" },
    { word: "bead", imageKey: "bead", letters: ["b", "e", "a", "d"], distractors: ["n"], mode: "decode" },
    { word: "read", imageKey: "read", letters: ["r", "e", "a", "d"], distractors: ["l"], mode: "decode" },
    { word: "heap", imageKey: "heap", letters: ["h", "e", "a", "p"], distractors: ["t", "o"], mode: "decode" },
    { word: "lean", imageKey: "lean", letters: ["l", "e", "a", "n"], distractors: ["d", "i"], mode: "decode" },
    { word: "peak", imageKey: "peak", letters: ["p", "e", "a", "k"], distractors: [], mode: "decode" },
    { word: "beak", imageKey: "beak", letters: ["b", "e", "a", "k"], distractors: [], mode: "decode" },
    { word: "deal", imageKey: "deal", letters: ["d", "e", "a", "l"], distractors: [], mode: "decode" },
    { word: "heal", imageKey: "heal", letters: ["h", "e", "a", "l"], distractors: [], mode: "decode" },
    { word: "real", imageKey: "real", letters: ["r", "e", "a", "l"], distractors: ["n"], mode: "decode" },
    { word: "beat", imageKey: "beat", letters: ["b", "e", "a", "t"], distractors: ["n"], mode: "decode" },
    { word: "teak", imageKey: "teak", letters: ["t", "e", "a", "k"], distractors: ["n", "o"], mode: "decode" },
    { word: "heat", imageKey: "heat", letters: ["h", "e", "a", "t"], distractors: ["s", "u"], mode: "decode" },
  ],
};
