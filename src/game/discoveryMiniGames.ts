...
// Only the final consonant differs. All real, decodable CVC words.

const ONSET_POOL: Record<string, string[]> = {
  // Short A onsets
  "ba": ["bag", "bad", "bat", "ban", "bam"],
  "ca": ["cat", "cap", "can", "cab", "cam"],
  "da": ["dad", "dam", "dab"],
  "fa": ["fan", "fat", "fad"],
  "ha": ["hat", "ham", "had", "has", "hag"],
  "ja": ["jam", "jab", "jag"],
  "la": ["lap", "lad", "lag", "lam"],
  "ma": ["map", "mat", "mad", "man", "mag"],
  "na": ["nap", "nag", "nab"],
  "pa": ["pan", "pat", "pad", "pal", "pam"],
  "ra": ["rat", "ram", "rag", "ran", "rap"],
  "sa": ["sad", "sat", "sap", "sag"],
  "ta": ["tag", "tab", "tap", "tan", "tam"],
  "va": ["van", "vat"],
  "wa": ["wag", "wax"],
