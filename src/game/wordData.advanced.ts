...
export const QUEST_ADV_AR_OR: Quest = {
  ...
  words: [
    { word: "sunset", imageKey: "sunset", letters: ["s", "u", "n", "s", "e", "t"], distractors: [], mode: "pending" },
    { word: "basket", imageKey: "basket", letters: ["b", "a", "s", "k", "e", "t"], distractors: [], mode: "pending" },
    { word: "rabbit", imageKey: "rabbit", letters: ["r", "a", "b", "b", "i", "t"], distractors: [], mode: "image" },
    { word: "napkin", imageKey: "napkin", letters: ["n", "a", "p", "k", "i", "n"], distractors: [], mode: "pending" },
    { word: "kitten", imageKey: "kitten", letters: ["k", "i", "t", "t", "e", "n"], distractors: ["r"], mode: "pending" },
    { word: "mitten", imageKey: "mitten", letters: ["m", "i", "t", "t", "e", "n"], distractors: ["s"], mode: "pending" },
    { word: "magnet", imageKey: "magnet", letters: ["m", "a", "g", "n", "e", "t"], distractors: ["r", "o"], mode: "pending" },
    { word: "puppet", imageKey: "puppet", letters: ["p", "u", "p", "p", "e", "t"], distractors: ["n", "a"], mode: "pending" },
    // Nodes 9-16
    { word: "picnic", imageKey: "picnic", letters: ["p", "i", "c", "n", "i", "c"], distractors: [], mode: "pending" },
    { word: "insect", imageKey: "insect", letters: ["i", "n", "s", "e", "c", "t"], distractors: [], mode: "pending" },
    { word: "cactus", imageKey: "cactus", letters: ["c", "a", "c", "t", "u", "s"], distractors: [], mode: "pending" },
    { word: "rocket", imageKey: "rocket", letters: ["r", "o", "c", "k", "e", "t"], distractors: [], mode: "pending" },
    { word: "pocket", imageKey: "pocket", letters: ["p", "o", "c", "k", "e", "t"], distractors: ["n"], mode: "pending" },
    { word: "jacket", imageKey: "jacket", letters: ["j", "a", "c", "k", "e", "t"], distractors: ["n"], mode: "pending" },
    { word: "helmet", imageKey: "helmet", letters: ["h", "e", "l", "m", "e", "t"], distractors: ["n", "a"], mode: "pending" },
    { word: "muffin", imageKey: "muffin", letters: ["m", "u", "f", "f", "i", "n"], distractors: ["t", "o"], mode: "pending" },
  ],
};
...
export const QUEST_ADV_ER_IR_UR: Quest = {
  ...
  words: [
    ...
    { word: "fishbowl", imageKey: "fishbowl", letters: ["f", "i", "s", "h", "b", "o", "w", "l"], distractors: ["n"], mode: "pending" },
    { word: "catnap", imageKey: "catnap", letters: ["c", "a", "t", "n", "a", "p"], distractors: ["r", "o"], mode: "pending" },
    { word: "hilltop", imageKey: "hilltop", letters: ["h", "i", "l", "l", "t", "o", "p"], distractors: ["n", "a"], mode: "pending" },
    // Nodes 9-16
    { word: "anthill", imageKey: "anthill", letters: ["a", "n", "t", "h", "i", "l", "l"], distractors: [], mode: "pending" },
    { word: "laptop", imageKey: "laptop", letters: ["l", "a", "p", "t", "o", "p"], distractors: [], mode: "image" },
    { word: "cobweb", imageKey: "cobweb", letters: ["c", "o", "b", "w", "e", "b"], distractors: [], mode: "pending" },
...
export const QUEST_ADV_BOSSY_R_MIX: Quest = {
  ...
  words: [
    ...
    { word: "blanket", imageKey: "blanket", letters: ["b", "l", "a", "n", "k", "e", "t"], distractors: [], mode: "pending" },
    { word: "pumpkin", imageKey: "pumpkin", letters: ["p", "u", "m", "p", "k", "i", "n"], distractors: [], mode: "pending" },
    { word: "trumpet", imageKey: "trumpet", letters: ["t", "r", "u", "m", "p", "e", "t"], distractors: [], mode: "image" },
    { word: "picnic", imageKey: "picnic", letters: ["p", "i", "c", "n", "i", "c"], distractors: ["t"], mode: "pending" },
    { word: "napkin", imageKey: "napkin", letters: ["n", "a", "p", "k", "i", "n"], distractors: ["t"], mode: "pending" },
    { word: "kitchen", imageKey: "kitchen", letters: ["k", "i", "t", "c", "h", "e", "n"], distractors: ["s", "o"], mode: "pending" },
    ...
    { word: "frisbee", imageKey: "frisbee", letters: ["f", "r", "i", "s", "b", "e", "e"], distractors: ["n"], mode: "pending" },
    { word: "penguin", imageKey: "penguin", letters: ["p", "e", "n", "g", "u", "i", "n"], distractors: ["t", "o"], mode: "pending" },
    { word: "monster", imageKey: "monster", letters: ["m", "o", "n", "s", "t", "e", "r"], distractors: ["d", "i"], mode: "pending" },
  ],
};
...
export const QUEST_ADV_2SYL_CLOSED: Quest = {
  ...
  words: [
    ...
    { word: "butter", imageKey: "butter", letters: ["b", "u", "t", "t", "e", "r"], distractors: ["n"], mode: "pending" },
    { word: "sister", imageKey: "sister", letters: ["s", "i", "s", "t", "e", "r"], distractors: ["n"], mode: "decode" },
    { word: "corner", imageKey: "corner", letters: ["c", "o", "r", "n", "e", "r"], distractors: ["t", "i"], mode: "pending" },
    { word: "market", imageKey: "market", letters: ["m", "a", "r", "k", "e", "t"], distractors: ["n", "i"], mode: "decode" },
    // Nodes 9-16
    { word: "doctor", imageKey: "doctor", letters: ["d", "o", "c", "t", "o", "r"], distractors: [], mode: "pending" },
...
export const QUEST_ADV_MIXED_MASTERY: Quest = {
  ...
  words: [
    ...
    { word: "doghouse", imageKey: "doghouse", letters: ["d", "o", "g", "h", "o", "u", "s", "e"], distractors: [], mode: "pending" },
    { word: "rainbow", imageKey: "rainbow", letters: ["r", "a", "i", "n", "b", "o", "w"], distractors: [], mode: "pending" },
    ...
    { word: "windmill", imageKey: "windmill", letters: ["w", "i", "n", "d", "m", "i", "l", "l"], distractors: [], mode: "pending" },
    { word: "goldfish", imageKey: "goldfish", letters: ["g", "o", "l", "d", "f", "i", "s", "h"], distractors: [], mode: "pending" },
    { word: "mushroom", imageKey: "mushroom", letters: ["m", "u", "s", "h", "r", "o", "o", "m"], distractors: ["n"], mode: "pending" },
