...
export const QUEST_MAGIC_E_A: Quest = {
  ...
  words: [
    ...
    { word: "name", imageKey: "name", letters: ["n", "a", "m", "e"], distractors: [], mode: "image" },
    { word: "make", imageKey: "make", letters: ["m", "a", "k", "e"], distractors: [], mode: "decode" },
    { word: "lake", imageKey: "lake", letters: ["l", "a", "k", "e"], distractors: [], mode: "image" },
    // Nodes 5-6: +1 distractor
    { word: "cape", imageKey: "cape", letters: ["c", "a", "p", "e"], distractors: ["n"], mode: "image" },
    { word: "gate", imageKey: "gate", letters: ["g", "a", "t", "e"], distractors: ["n"], mode: "image" },
    // Nodes 7-8: +2 distractors
    { word: "maze", imageKey: "maze", letters: ["m", "a", "z", "e"], distractors: ["n", "o"], mode: "image" },
    { word: "wave", imageKey: "wave", letters: ["w", "a", "v", "e"], distractors: ["t", "o"], mode: "image" },
    // === NODES 9-16 (after Trophy Room) ===
    { word: "tape", imageKey: "tape", letters: ["t", "a", "p", "e"], distractors: [], mode: "image" },
    ...
    { word: "safe", imageKey: "safe", letters: ["s", "a", "f", "e"], distractors: ["n"], mode: "image" },
    { word: "game", imageKey: "game", letters: ["g", "a", "m", "e"], distractors: ["t"], mode: "image" },
    // Nodes 15-16: +2 distractors
    { word: "face", imageKey: "face", letters: ["f", "a", "c", "e"], distractors: ["k", "o"], mode: "image" },
    { word: "race", imageKey: "race", letters: ["r", "a", "c", "e"], distractors: ["n", "u"], mode: "image" },
  ],
};
...
export const QUEST_MAGIC_E_I: Quest = {
  ...
  words: [
    ...
    { word: "line", imageKey: "line", letters: ["l", "i", "n", "e"], distractors: [], mode: "image" },
    ...
    { word: "nine", imageKey: "nine", letters: ["n", "i", "n", "e"], distractors: ["t"], mode: "image" },
    { word: "pine", imageKey: "pine", letters: ["p", "i", "n", "e"], distractors: ["t", "a"], mode: "image" },
    { word: "hide", imageKey: "hide", letters: ["h", "i", "d", "e"], distractors: ["t", "a"], mode: "image" },
    // Nodes 9-16
    { word: "ride", imageKey: "ride", letters: ["r", "i", "d", "e"], distractors: [], mode: "image" },
    { word: "dice", imageKey: "dice", letters: ["d", "i", "c", "e"], distractors: [], mode: "image" },
    { word: "mice", imageKey: "mice", letters: ["m", "i", "c", "e"], distractors: [], mode: "image" },
    { word: "life", imageKey: "life", letters: ["l", "i", "f", "e"], distractors: [], mode: "decode" },
    { word: "vine", imageKey: "vine", letters: ["v", "i", "n", "e"], distractors: ["d"], mode: "image" },
...
export const QUEST_MAGIC_E_O: Quest = {
  ...
  words: [
    ...
    { word: "rope", imageKey: "rope", letters: ["r", "o", "p", "e"], distractors: [], mode: "image" },
    { word: "nose", imageKey: "nose", letters: ["n", "o", "s", "e"], distractors: [], mode: "image" },
    ...
    { word: "rose", imageKey: "rose", letters: ["r", "o", "s", "e"], distractors: ["n"], mode: "image" },
    { word: "hole", imageKey: "hole", letters: ["h", "o", "l", "e"], distractors: ["n", "a"], mode: "image" },
    { word: "pole", imageKey: "pole", letters: ["p", "o", "l", "e"], distractors: ["t", "i"], mode: "image" },
    // Nodes 9-16
    { word: "note", imageKey: "note", letters: ["n", "o", "t", "e"], distractors: [], mode: "image" },
    ...
    { word: "joke", imageKey: "joke", letters: ["j", "o", "k", "e"], distractors: [], mode: "image" },
    { word: "woke", imageKey: "woke", letters: ["w", "o", "k", "e"], distractors: ["n"], mode: "decode" },
    { word: "zone", imageKey: "zone", letters: ["z", "o", "n", "e"], distractors: ["t"], mode: "image" },
    { word: "dome", imageKey: "dome", letters: ["d", "o", "m", "e"], distractors: ["n", "a"], mode: "image" },
...
export const QUEST_MAGIC_E_U: Quest = {
  ...
  patternType: "magic-e",
  words: [
    { word: "cute", imageKey: "cute", letters: ["c", "u", "t", "e"], distractors: [], mode: "image" },
    { word: "cube", imageKey: "cube", letters: ["c", "u", "b", "e"], distractors: [], mode: "image" },
    { word: "mule", imageKey: "mule", letters: ["m", "u", "l", "e"], distractors: [], mode: "image" },
    { word: "tune", imageKey: "tune", letters: ["t", "u", "n", "e"], distractors: [], mode: "image" },
    { word: "dune", imageKey: "dune", letters: ["d", "u", "n", "e"], distractors: ["t"], mode: "image" },
    { word: "rule", imageKey: "rule", letters: ["r", "u", "l", "e"], distractors: ["n"], mode: "decode" },
    { word: "huge", imageKey: "huge", letters: ["h", "u", "g", "e"], distractors: ["t", "a"], mode: "image" },
...
export const QUEST_MAGIC_E_MIXED: Quest = {
  ...
  words: [
    { word: "make", imageKey: "make", letters: ["m", "a", "k", "e"], distractors: [], mode: "decode" },
    { word: "hope", imageKey: "hope", letters: ["h", "o", "p", "e"], distractors: [], mode: "decode" },
    { word: "bite", imageKey: "bite", letters: ["b", "i", "t", "e"], distractors: [], mode: "image" },
    { word: "mile", imageKey: "mile", letters: ["m", "i", "l", "e"], distractors: [], mode: "image" },
    ...
    // Nodes 9-16
    { word: "date", imageKey: "date", letters: ["d", "a", "t", "e"], distractors: [], mode: "image" },
    { word: "pile", imageKey: "pile", letters: ["p", "i", "l", "e"], distractors: [], mode: "image" },
    { word: "poke", imageKey: "poke", letters: ["p", "o", "k", "e"], distractors: [], mode: "image" },
    { word: "fume", imageKey: "fume", letters: ["f", "u", "m", "e"], distractors: [], mode: "image" },
    { word: "fade", imageKey: "fade", letters: ["f", "a", "d", "e"], distractors: ["n"], mode: "image" },
    { word: "June", imageKey: "june", letters: ["j", "u", "n", "e"], distractors: ["t"], mode: "image" },
    { word: "sake", imageKey: "sake", letters: ["s", "a", "k", "e"], distractors: ["n", "o"], mode: "image" },
    { word: "dose", imageKey: "dose", letters: ["d", "o", "s", "e"], distractors: ["n", "a"], mode: "image" },
  ],
};
