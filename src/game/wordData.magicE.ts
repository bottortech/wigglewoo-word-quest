...
export const QUEST_MAGIC_E_A: Quest = {
  ...
  words: [
    ...
    { word: "lake", imageKey: "lake", letters: ["l", "a", "k", "e"], distractors: [], mode: "decode" },
    { word: "gate", imageKey: "gate", letters: ["g", "a", "t", "e"], distractors: ["n"], mode: "decode" },
    { word: "wave", imageKey: "wave", letters: ["w", "a", "v", "e"], distractors: ["t", "o"], mode: "decode" },
    { word: "tape", imageKey: "tape", letters: ["t", "a", "p", "e"], distractors: [], mode: "decode" },
...
export const QUEST_MAGIC_E_I: Quest = {
  ...
  words: [
    ...
    { word: "mice", imageKey: "mice", letters: ["m", "i", "c", "e"], distractors: [], mode: "decode" },
...
export const QUEST_MAGIC_E_O: Quest = {
  ...
  words: [
    ...
    { word: "rope", imageKey: "rope", letters: ["r", "o", "p", "e"], distractors: [], mode: "decode" },
    { word: "nose", imageKey: "nose", letters: ["n", "o", "s", "e"], distractors: [], mode: "decode" },
    { word: "rose", imageKey: "rose", letters: ["r", "o", "s", "e"], distractors: ["n"], mode: "decode" },
    ...
    { word: "note", imageKey: "note", letters: ["n", "o", "t", "e"], distractors: [], mode: "decode" },
...
export const QUEST_MAGIC_E_U: Quest = {
  ...
  words: [
    ...
    { word: "mule", imageKey: "mule", letters: ["m", "u", "l", "e"], distractors: [], mode: "decode" },
    { word: "tune", imageKey: "tune", letters: ["t", "u", "n", "e"], distractors: [], mode: "decode" },
    ...
    { word: "huge", imageKey: "huge", letters: ["h", "u", "g", "e"], distractors: ["t", "a"], mode: "decode" },
