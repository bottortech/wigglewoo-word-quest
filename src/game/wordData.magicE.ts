...
export const QUEST_MAGIC_E_A: Quest = {
  ...
  words: [
    ...
    { word: "name", imageKey: "name", letters: ["n", "a", "m", "e"], distractors: [], mode: "decode" },
    ...
    { word: "safe", imageKey: "safe", letters: ["s", "a", "f", "e"], distractors: ["n"], mode: "decode" },
    { word: "face", imageKey: "face", letters: ["f", "a", "c", "e"], distractors: ["k", "o"], mode: "decode" },
    { word: "race", imageKey: "race", letters: ["r", "a", "c", "e"], distractors: ["n", "u"], mode: "decode" },
  ],
};
...
export const QUEST_MAGIC_E_I: Quest = {
  ...
  words: [
    ...
    { word: "line", imageKey: "line", letters: ["l", "i", "n", "e"], distractors: [], mode: "decode" },
    { word: "nine", imageKey: "nine", letters: ["n", "i", "n", "e"], distractors: ["t"], mode: "decode" },
    { word: "pine", imageKey: "pine", letters: ["p", "i", "n", "e"], distractors: ["t", "a"], mode: "decode" },
    { word: "hide", imageKey: "hide", letters: ["h", "i", "d", "e"], distractors: ["t", "a"], mode: "decode" },
    ...
    { word: "vine", imageKey: "vine", letters: ["v", "i", "n", "e"], distractors: ["d"], mode: "decode" },
...
export const QUEST_MAGIC_E_O: Quest = {
  ...
  words: [
    ...
    { word: "hole", imageKey: "hole", letters: ["h", "o", "l", "e"], distractors: ["n", "a"], mode: "decode" },
    { word: "pole", imageKey: "pole", letters: ["p", "o", "l", "e"], distractors: ["t", "i"], mode: "decode" },
    ...
    { word: "joke", imageKey: "joke", letters: ["j", "o", "k", "e"], distractors: [], mode: "decode" },
    { word: "woke", imageKey: "woke", letters: ["w", "o", "k", "e"], distractors: ["n"], mode: "decode" },
    { word: "zone", imageKey: "zone", letters: ["z", "o", "n", "e"], distractors: ["t"], mode: "decode" },
    { word: "dome", imageKey: "dome", letters: ["d", "o", "m", "e"], distractors: ["n", "a"], mode: "decode" },
...
export const QUEST_MAGIC_E_MIXED: Quest = {
  ...
  words: [
    ...
    { word: "mile", imageKey: "mile", letters: ["m", "i", "l", "e"], distractors: [], mode: "decode" },
    ...
    { word: "pile", imageKey: "pile", letters: ["p", "i", "l", "e"], distractors: [], mode: "decode" },
    { word: "poke", imageKey: "poke", letters: ["p", "o", "k", "e"], distractors: [], mode: "decode" },
    ...
    { word: "sake", imageKey: "sake", letters: ["s", "a", "k", "e"], distractors: ["n", "o"], mode: "decode" },
