...
export type EventSlug =
  ...
  // Discovery Room unlocked / next vowel quest unlocked. Not played for the
  // "activity"/"room" tiers, which are embedded inside screens that already
  // manage their own audio.
